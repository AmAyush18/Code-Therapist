export const styles = {
    ...
    button: "flex flex-row justify-center items-center py-3 px-3 rounded-full cursor-pointer bg-red-400 dark:bg-[#34d399] min-h-[45px] w-full text-[16px] text-[#ffffff] font-Poppins font-semibold"
}